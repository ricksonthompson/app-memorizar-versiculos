...
const VerseForm = ({ onAddVerse }: { onAddVerse: (verse: { text: string; reference: string; version: string; month: string; year: string; week: string; }) => void }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="p-4 bg-gray-100 rounded shadow-md">
            <h2 className="text-lg font-semibold mb-4">Adicionar Novo Versículo</h2>
            <div className="mb-4">
